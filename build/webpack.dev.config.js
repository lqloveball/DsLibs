...
var webpackEntry = getEntries(resolveBowerPath('./WebH5Template/src'), 'js');
//一些公共库
webpackEntry.base = [
    'jquery',
    'eventdispatcher',
...
module.exports = merge(webpackBaseConfig, {
    ...
    output: {
        //输出路径
        path: resolveBowerPath('./WebH5Template/js/app/'),
        //输出程序入口  输出名称或名称 pattern
        filename: "[name].js?[hash]",
        //指定静态资源的位置
        publicPath: './WebH5Template/js/app/', // 设置require.ensure路径
        //输出第三方支持库压缩
