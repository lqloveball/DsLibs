...
module.exports = {
    ...
    resolve: {
        alias: {
            assets: resolveBowerPath('./WebH5Template/assets'),
            images: resolveBowerPath('./WebH5Template/images'),
            app: resolveBowerPath('./WebH5Template/src/app'),
            libs: resolveBowerPath('./src/libs'),
            ds: resolveBowerPath('./src/ds'),//默认不使用源码
            //vue需要用到
