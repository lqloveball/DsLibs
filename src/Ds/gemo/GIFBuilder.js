...
(function(factory) {
  ...
  function GIFBuilder(config) {
    ...
    //生成后的GIF的Blob数据
    var _GIFBlob;
    Object.defineProperty(this, "GIFBlob", {get: function() {return _GIFBlob;},});
    var _GIFBase64;
    Object.defineProperty(this, "GIFBase64", {get: function() {return _GIFBase64;},});
    //是否编译过程中
    var _IsBuild=false;
    //编译后callback方法
    ...
    this.AddFrame=function(img,delay){
      ...
      delay=delay||200;
      _GIFer.addFrame(img, {delay: delay});
      _Frames.push(img);
    };
