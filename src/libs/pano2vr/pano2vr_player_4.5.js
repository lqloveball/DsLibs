...
(function () {
  ...
  function Ib(h, q, p) {
      var H, B = p[0], m = p[1], p = p[2], X = Math.sqrt(B * B + m * m + p * p);
      if (X) {
          1 != X && (X = 1 / X,
          B *= X,
          m *= X,
  ...
  function Mc() {
      var h = "perspective", q = ["Webkit", "Moz", "O", "ms", "Ms"], p;
      p = r;
  ...
  function pano2vrPlayer(h) {
      ...
      function wa() {
          var a, d = document.createElement("fakeelement"), c = {
      ...
      function Da() {
          ...
          if (0 < y.length)
              for (d = 0; d < y.length; d++)
                  y[d].Ra && y[d].$a != y[d].obj.currentTime && (y[d].$a = y[d].obj.currentTime,
                  !y[d].Va && 0 < y[d].obj.videoHeight && (y[d].Va = y[d].obj.videoWidth / y[d].obj.videoHeight));
          if (0 < R) {
              if (2 == R)
      ...
      function Kd(a) {
          var d = "", c, b, e = "", g, h = "", k = 0, a = a.replace(/[^A-Za-z0-9\+\/\=]/g, "");
          do
      ...
      var u = 0, Ic = 0, ib = 0, hb = 360, G = 0, Xb = 0, x = 0, Jc = 0, La = -90, Ka = 90, O = 0, la = 0, A = 90, Mb = 90, ka = 1, Cc = 0, sa = 170, lb = 0, N = 0, Kc = 0, cd, bd, z = 320, t = 480, uc = 0, vc = 0, Fa = 0, Ga = 0, hd = 0, id = 0, yc = 0, zc = 0, vb = 0, wb = 0, Q = -1, Xc = 0, Yc = 0, Bb = 0, Cb = 0, Zc = 0, $c = 0, tc, gc = l, tb = 0, ub = 0, qa = 0, ra = 0, xb = r, V = 0, Qa = 0, s = o, Ba = o, na = o, S = b.c = o, $ = o;
      b.control = o;
      b.checkLoaded = [];
      b.isFullscreen = r;
      b.dirty = r;
      ...
      b.startNode = "";
      b.onMoveComplete = o;
      var Kb = 0, Wb = [], mb = [], nb = 1, Gb = 1, Hb = 1024, Ed = 0, Fd = 0, Ab = r, nc = 5, ia = r, oc = r, Ra = 0.4, Lb = 0, mc = 0, Rc = l, jb, zb = r, Qc = 0.1, ic = 0, jc = 0, kc, lc;
      b.skinObj = o;
      b.userdata = {};
      b.userdata.title = "";
      ...
      var C = [], y = [], fa = [], ob = [], va = [], Y = 1, D = [], pb = "0x000000", sd = 0.4, ta, L, pd, Sa = 0, kb = 0.01, Tc = 2, pc = 0, Nb = r, Sc = r, Z = 0, ba = 0, cc = 0, dc = 0, Pb = r, ca = r, xc = r, Pa = l, ed = r, fd = 1, sc = l, gb = 8;
      R = 1;
      ja = 0;
      ya = 0;
      Dc = 255;
      ...
      var ga = r, Ca = r, yb = r, Yb = l, Gd = r, Lc = l, qc = r, U = 0, Zb = 10, Hd = 200, Eb = "", I = "", xa = "transition", T = "transform", za = "perspective", g, yd = new P, zd = new P, Ad = new P, Bd = new P, Cd = new P;
      b.Ba = r;
      var Jb = "";
      unusedTileCanvas = [];
                  ...
                  if (g) {
                      ...
                      for (e = 0; e < D.length; e++) {
                          ...
                          for (var n in level.g)
                              level.g.hasOwnProperty(n) && (d = level.g[n],
                              !d.ja && !level.t && (d.M && g.deleteTexture(d.M),
                              d.a = o,
                              delete level.g[n]))
                      }
                      b.T = r
              ...
              if (0 < D.length) {
                  ...
                  if (0 < D.length) {
                      ...
                      for (h = 0; h < D.length; h++)
                          for (e in level = D[h],
                          level.g)
                              level.g.hasOwnProperty(e) && (k = level.g[e],
                              !k.ja && k.b && (level.t ? (a = "translate3d(-10px,-10px,0px) scale(0.001,0.001)",
                              k.b ? (k.b.style[T] = a,
      ...
      ;
      var da = [], ea = new glMatrixArrayType(16), Ma = new glMatrixArrayType(16), Ac, Ub, Vb;
      b.getPan = function() {
          return u
      }
      ;
      ...
      b.Wa = function() {
          ...
          a.addEventListener ? (a.addEventListener("touchstart", Md, r),
      ...
      b.playSound = function(a, b) {
          var c = B(a);
          c && (c.obj.r = b && !isNaN(Number(b)) ? Number(b) - 1 : c.loop - 1,
          -1 == c.obj.r && (c.obj.r = 1E7),
          c.obj.play())
      }
      ;
