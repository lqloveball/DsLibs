...
class VideoInteractivePlayer extends EventDispatcher {
     ...
     */
    load() {
        if (this._type === 'mpg' || this._type === 'ts' || this._type === 'fs') this._videoPlayer.load();
    }
    ...
    /**
     * 是否执行开始加载 video标签是默认有load的
     * @return {boolean}
     */
    get isStarload() {
        return this._videoPlayer._isStarload;
    }
     ...
     */
    get isLoadEnd(){
        return this._videoPlayer._isLoadEnd;
    }
