...
!(function (factory) {
     ...
     *
     * ```
     * @param {string} [opts.baseUrl='./js/edslibs/base.js'] base.js路径设置
     * @param {string} [opts.cjsUrl='./js/edslibs/createjsFrameWork.js'] createjsFrameWork.js路径设置
     ...
     * @param {function} [opts.baseEnd=undefined] 基础框架load完成并且SiteModel构建带有事件功能时候调用
     *
     * @example
     *
    ...
    function SiteModelByMobile(loadSPA, type, opts) {
         ...
         * @type {ds.net.SiteWechatShareModel}
         */
        ...
        function loadBaseFrameWork() {
            ...
            var _url = opts.baseUrl || './js/edslibs/base.js';
        ...
        function _resize(e) {
            ...
            if (_self.resizeModel.type === 'auto'&&_self.isMobile) {

                if (_self.createJsModel) {

                    if (_self.resizeModel.screenWidth === 640) _self.createJsModel.size(_self.resizeModel.screenWidth, 1235);
        ...
        this.beforeSinglePageApplicationLoadAssets = function (callback) {
            ...
            _self.getScriptList(_other, function () {
                ...
                if (_self.ds) _self.ds({
                    type:'otherJsProgress',
                    progress:progress
                });
    ...
    function getScriptList(list, complete,progress) {
        ...
        function load() {
            ...
            if (_index >= list.length) {
                ...
                if(progress)progress(_index/list.length,_index,list.length);
            }
