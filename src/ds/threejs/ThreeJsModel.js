...
class ThreeJsModel extends EventDispatcher {
     ...
     * @param {boolean} [opts.sortObjects=false] 透明元素排序
     ...
     * @param {boolean} [opts.resizeType=true] 自适应类型 'window' 'fixed' 'fixed2'
    ...
    constructor(opts) {
        ...
        let _sortObjects = opts.sortObjects !== undefined ? opts.sortObjects : false;
        ...
        //  创建相机
        //摄像机垂直视角
        let _cameraFov = opts.cameraFov || 60;
        //摄像机垂直视角
    ...
    set intersectDom(value) {
        ...
        if (this._intersectDom) {
            ...
            this._intersectDom.off('mousemove', this[_documentMouseMoveEvent], false);
            this._intersectDom.off('touchmove', this[_documentMouseMoveEvent], false);

        }

        this[_documentMouseMoveEvent] = documentMouseMoveEvent.bind(this);
        this._intersectDom = $(value);
        this._intersectDom.on('mousemove', this[_documentMouseMoveEvent], false);
        this._intersectDom.on('touchmove', this[_documentMouseMoveEvent], false);
    ...
    _intersectUpDate() {
        ...
        if (_intersects.length > 0) {
            ...
            this.render.domElement.style.cursor = 'pointer';

        } else {

            this.render.domElement.style.cursor = 'auto';
