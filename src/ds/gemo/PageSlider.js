...
class PageSlider extends EventDispatcher {
    ...
    constructor(touchDom, opts) {
        ...
        this.scenesTouchstart = scenesTouchstart.bind(this);
        this.scenes.on('touchstart', this.scenesTouchstart);

        this.scenesTouchmove = scenesTouchmove.bind(this);
        this.scenes.on('touchstart', this.scenesTouchmove);

        this.scenesTouchend = scenesTouchend.bind(this);
        this.scenes.on('touchend', this.scenesTouchend);
        this.scenes.on('touchcancel', this.scenesTouchend);
