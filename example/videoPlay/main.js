!(function() {
    ...
    var Model = function() {
        ...
        //自适应
        var _SiteResizeModel = new Ds.SiteMoblieTemplate({
          screen:'#screen',
        });
        ...
        function Init(){
          log('SiteModel Init');
          if(_Self.OS=='ios'){
            _VideoInteractivePlayer=new Ds.media.VideoInteractivePlayer('video1.mp4','video',{
            ...
            _VideoInteractivePlayer=new Ds.media.VideoInteractivePlayer('out.mpg','canvas',{
              append:'#videoPanel',
              autoplay:false,
              progressive:true,
              seekable:true,
