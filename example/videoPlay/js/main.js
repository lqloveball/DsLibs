        ...
        function Init(){
          ...
          if(_Self.OS=='ios'){
            ...
            _VideoInteractivePlayer=new Ds.media.VideoInteractivePlayer('media/video1.mp4','video',{
              ...
              $('#videoType').html('使用 mpeg视频播放:点击开始');
            _VideoInteractivePlayer=new Ds.media.VideoInteractivePlayer('media/video1.ts','mpegByts',{
              append:'#videoPanel',
              autoplay:false,
              progressive:true,
              throttled:false,
            ...
            window.Player=_VideoInteractivePlayer.VideoPlayer.Player;
          }
          ...
          $('.play10s').on('touchstart',function(){
            _VideoInteractivePlayer.SeekToTime(10);

          });
          $('.play20s').on('touchstart',function(){
            _VideoInteractivePlayer.SeekToTime(20);

          });
          $('.pause4s').on('touchstart',function(){
            _VideoInteractivePlayer.SeekToTime(4);

          });
          // $('#touchDom').on('touchend',function(){
          //   _VideoInteractivePlayer.Pause();
          // });
